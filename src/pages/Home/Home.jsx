...
import green from "../../assets/green.jpg"; // Corrected import path
import logo from "../../assets/namelogo1.png"; // Ensure correct import path
import "./Home.css";
            ...
            <div className="sec1">
                ...
                <div className="nav-list">
                    <ul>
                        ...
                        <li><Link to="/account">Account</Link></li> {/* Use Link for navigation */}
                    </ul>
                </div>
            </div>
            <div className="Logo">
