 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Ou;function Dx(){if(Ou)return ie;Ou=1;var o=Symbol.for("react.transitional.element"),u=Symbol.for("react.portal"),h=Symbol.for("react.fragment"),d=Symbol.for("react.strict_mode"),p=Symbol.for("react.profiler"),g=Symbol.for("react.consumer"),S=Symbol.for("react.context"),N=Symbol.for("react.forward_ref"),b=Symbol.for("react.suspense"),x=Symbol.for("react.memo"),C=Symbol.for("react.lazy"),M=Symbol.iterator;function L(m){return m===null||typeof m!="object"?null:(m=M&&m[M]||m["@@iterator"],typeof m=="function"?m:null)}var W={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},X=Object.assign,H={};function P(m,R,I){this.props=m,this.context=R,this.refs=H,this.updater=I||W}P.prototype.isReactComponent={},P.prototype.setState=function(m,R){if(typeof m!="object"&&typeof m!="function"&&m!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,m,R,"setState")},P.prototype.forceUpdate=function(m){this.updater.enqueueForceUpdate(this,m,"forceUpdate")};function Y(){}Y.prototype=P.prototype;function _(m,R,I){this.props=m,this.context=R,this.refs=H,this.updater=I||W}var B=_.prototype=new Y;B.constructor=_,X(B,P.prototype),B.isPureReactComponent=!0;var ce=Array.isArray,J={H:null,A:null,T:null,S:null,V:null},Me=Object.prototype.hasOwnProperty;function ze(m,R,I,U,K,de){return I=de.ref,{$$typeof:o,type:m,key:R,ref:I!==void 0?I:null,props:de}}function _e(m,R){return ze(m.type,R,void 0,void 0,void 0,m.props)}function Se(m){return typeof m=="object"&&m!==null&&m.$$typeof===o}function tt(m){var R={"=":"=0",":":"=2"};return"$"+m.replace(/[=:]/g,function(I){return R[I]})}var ut=/\/+/g;function Ge(m,R){return typeof m=="object"&&m!==null&&m.key!=null?tt(""+m.key):R.toString(36)}function Tn(){}function kn(m){switch(m.status){case"fulfilled":return m.value;case"rejected":throw m.reason;default:switch(typeof m.status=="string"?m.then(Tn,Tn):(m.status="pending",m.then(function(R){m.status==="pending"&&(m.status="fulfilled",m.value=R)},function(R){m.status==="pending"&&(m.status="rejected",m.reason=R)})),m.status){case"fulfilled":return m.value;case"rejected":throw m.reason}}throw m}function Ve(m,R,I,U,K){var de=typeof m;(de==="undefined"||de==="boolean")&&(m=null);var ne=!1;if(m===null)ne=!0;else switch(de){case"bigint":case"string":case"number":ne=!0;break;case"object":switch(m.$$typeof){case o:case u:ne=!0;break;case C:return ne=m._init,Ve(ne(m._payload),R,I,U,K)}}if(ne)return K=K(m),ne=U===""?"."+Ge(m,0):U,ce(K)?(I="",ne!=null&&(I=ne.replace(ut,"$&/")+"/"),Ve(K,R,I,"",function(Zt){return Zt})):K!=null&&(Se(K)&&(K=_e(K,I+(K.key==null||m&&m.key===K.key?"":(""+K.key).replace(ut,"$&/")+"/")+ne)),R.push(K)),1;ne=0;var nt=U===""?".":U+":";if(ce(m))for(var ve=0;ve<m.length;ve++)U=m[ve],de=nt+Ge(U,ve),ne+=Ve(U,R,I,de,K);else if(ve=L(m),typeof ve=="function")for(m=ve.call(m),ve=0;!(U=m.next()).done;)U=U.value,de=nt+Ge(U,ve++),ne+=Ve(U,R,I,de,K);else if(de==="object"){if(typeof m.then=="function")return Ve(kn(m),R,I,U,K);throw R=String(m),Error("Objects are not valid as a React child (found: "+(R==="[object Object]"?"object with keys {"+Object.keys(m).join(", ")+"}":R)+"). If you meant to render a collection of children, use an array instead.")}return ne}function O(m,R,I){if(m==null)return m;var U=[],K=0;return Ve(m,U,"","",function(de){return R.call(I,de,K++)}),U}function q(m){if(m._status===-1){var R=m._result;R=R(),R.then(function(I){(m._status===0||m._status===-1)&&(m._status=1,m._result=I)},function(I){(m._status===0||m._status===-1)&&(m._status=2,m._result=I)}),m._status===-1&&(m._status=0,m._result=R)}if(m._status===1)return m._result.default;throw m._result}var ee=typeof reportError=="function"?reportError:function(m){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var R=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof m=="object"&&m!==null&&typeof m.message=="string"?String(m.message):String(m),error:m});if(!window.dispatchEvent(R))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",m);return}console.error(m)};function ge(){}return ie.Children={map:O,forEach:function(m,R,I){O(m,function(){R.apply(this,arguments)},I)},count:function(m){var R=0;return O(m,function(){R++}),R},toArray:function(m){return O(m,function(R){return R})||[]},only:function(m){if(!Se(m))throw Error("React.Children.only expected to receive a single React element child.");return m}},ie.Component=P,ie.Fragment=h,ie.Profiler=p,ie.PureComponent=_,ie.StrictMode=d,ie.Suspense=b,ie.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=J,ie.__COMPILER_RUNTIME={__proto__:null,c:function(m){return J.H.useMemoCache(m)}},ie.cache=function(m){return function(){return m.apply(null,arguments)}},ie.cloneElement=function(m,R,I){if(m==null)throw Error("The argument must be a React element, but you passed "+m+".");var U=X({},m.props),K=m.key,de=void 0;if(R!=null)for(ne in R.ref!==void 0&&(de=void 0),R.key!==void 0&&(K=""+R.key),R)!Me.call(R,ne)||ne==="key"||ne==="__self"||ne==="__source"||ne==="ref"&&R.ref===void 0||(U[ne]=R[ne]);var ne=arguments.length-2;if(ne===1)U.children=I;else if(1<ne){for(var nt=Array(ne),ve=0;ve<ne;ve++)nt[ve]=arguments[ve+2];U.children=nt}return ze(m.type,K,void 0,void 0,de,U)},ie.createContext=function(m){return m={$$typeof:S,_currentValue:m,_currentValue2:m,_threadCount:0,Provider:null,Consumer:null},m.Provider=m,m.Consumer={$$typeof:g,_context:m},m},ie.createElement=function(m,R,I){var U,K={},de=null;if(R!=null)for(U in R.key!==void 0&&(de=""+R.key),R)Me.call(R,U)&&U!=="key"&&U!=="__self"&&U!=="__source"&&(K[U]=R[U]);var ne=arguments.length-2;if(ne===1)K.children=I;else if(1<ne){for(var nt=Array(ne),ve=0;ve<ne;ve++)nt[ve]=arguments[ve+2];K.children=nt}if(m&&m.defaultProps)for(U in ne=m.defaultProps,ne)K[U]===void 0&&(K[U]=ne[U]);return ze(m,de,void 0,void 0,null,K)},ie.createRef=function(){return{current:null}},ie.forwardRef=function(m){return{$$typeof:N,render:m}},ie.isValidElement=Se,ie.lazy=function(m){return{$$typeof:C,_payload:{_status:-1,_result:m},_init:q}},ie.memo=function(m,R){return{$$typeof:x,type:m,compare:R===void 0?null:R}},ie.startTransition=function(m){var R=J.T,I={};J.T=I;try{var U=m(),K=J.S;K!==null&&K(I,U),typeof U=="object"&&U!==null&&typeof U.then=="function"&&U.then(ge,ee)}catch(de){ee(de)}finally{J.T=R}},ie.unstable_useCacheRefresh=function(){return J.H.useCacheRefresh()},ie.use=function(m){return J.H.use(m)},ie.useActionState=function(m,R,I){return J.H.useActionState(m,R,I)},ie.useCallback=function(m,R){return J.H.useCallback(m,R)},ie.useContext=function(m){return J.H.useContext(m)},ie.useDebugValue=function(){},ie.useDeferredValue=function(m,R){return J.H.useDeferredValue(m,R)},ie.useEffect=function(m,R,I){var U=J.H;if(typeof I=="function")throw Error("useEffect CRUD overload is not enabled in this build of React.");return U.useEffect(m,R)},ie.useId=function(){return J.H.useId()},ie.useImperativeHandle=function(m,R,I){return J.H.useImperativeHandle(m,R,I)},ie.useInsertionEffect=function(m,R){return J.H.useInsertionEffect(m,R)},ie.useLayoutEffect=function(m,R){return J.H.useLayoutEffect(m,R)},ie.useMemo=function(m,R){return J.H.useMemo(m,R)},ie.useOptimistic=function(m,R){return J.H.useOptimistic(m,R)},ie.useReducer=function(m,R,I){return J.H.useReducer(m,R,I)},ie.useRef=function(m){return J.H.useRef(m)},ie.useState=function(m){return J.H.useState(m)},ie.useSyncExternalStore=function(m,R,I){return J.H.useSyncExternalStore(m,R,I)},ie.useTransition=function(){return J.H.useTransition()},ie.version="19.1.1",ie}var Nu;function Oo(){return Nu||(Nu=1,bo.exports=Dx()),bo.exports}var A=Oo();const zx=Fu(A);var vo={exports:{}},Os={},wo={exports:{}},To={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Du;function Rx(){return Du||(Du=1,function(o){function u(O,q){var ee=O.length;O.push(q);e:for(;0<ee;){var ge=ee-1>>>1,m=O[ge];if(0<p(m,q))O[ge]=q,O[ee]=m,ee=ge;else break e}}function h(O){return O.length===0?null:O[0]}function d(O){if(O.length===0)return null;var q=O[0],ee=O.pop();if(ee!==q){O[0]=ee;e:for(var ge=0,m=O.length,R=m>>>1;ge<R;){var I=2*(ge+1)-1,U=O[I],K=I+1,de=O[K];if(0>p(U,ee))K<m&&0>p(de,U)?(O[ge]=de,O[K]=ee,ge=K):(O[ge]=U,O[I]=ee,ge=I);else if(K<m&&0>p(de,ee))O[ge]=de,O[K]=ee,ge=K;else break e}}return q}function p(O,q){var ee=O.sortIndex-q.sortIndex;return ee!==0?ee:O.id-q.id}if(o.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var g=performance;o.unstable_now=function(){return g.now()}}else{var S=Date,N=S.now();o.unstable_now=function(){return S.now()-N}}var b=[],x=[],C=1,M=null,L=3,W=!1,X=!1,H=!1,P=!1,Y=typeof setTimeout=="function"?setTimeout:null,_=typeof clearTimeout=="function"?clearTimeout:null,B=typeof setImmediate<"u"?setImmediate:null;function ce(O){for(var q=h(x);q!==null;){if(q.callback===null)d(x);else if(q.startTime<=O)d(x),q.sortIndex=q.expirationTime,u(b,q);else break;q=h(x)}}function J(O){if(H=!1,ce(O),!X)if(h(b)!==null)X=!0,Me||(Me=!0,Ge());else{var q=h(x);q!==null&&Ve(J,q.startTime-O)}}var Me=!1,ze=-1,_e=5,Se=-1;function tt(){return P?!0:!(o.unstable_now()-Se<_e)}function ut(){if(P=!1,Me){var O=o.unstable_now();Se=O;var q=!0;try{e:{X=!1,H&&(H=!1,_(ze),ze=-1),W=!0;var ee=L;try{t:{for(ce(O),M=h(b);M!==null&&!(M.expirationTime>O&&tt());){var ge=M.callback;if(typeof ge=="function"){M.callback=null,L=M.priorityLevel;var m=ge(M.expirationTime<=O);if(O=o.unstable_now(),typeof m=="function"){M.callback=m,ce(O),q=!0;break t}M===h(b)&&d(b),ce(O)}else d(b);M=h(b)}if(M!==null)q=!0;else{var R=h(x);R!==null&&Ve(J,R.startTime-O),q=!1}}break e}finally{M=null,L=ee,W=!1}q=void 0}}finally{q?Ge():Me=!1}}}var Ge;if(typeof B=="function")Ge=function(){B(ut)};else if(typeof MessageChannel<"u"){var Tn=new MessageChannel,kn=Tn.port2;Tn.port1.onmessage=ut,Ge=function(){kn.postMessage(null)}}else Ge=function(){Y(ut,0)};function Ve(O,q){ze=Y(function(){O(o.unstable_now())},q)}o.unstable_IdlePriority=5,o.unstable_ImmediatePriority=1,o.unstable_LowPriority=4,o.unstable_NormalPriority=3,o.unstable_Profiling=null,o.unstable_UserBlockingPriority=2,o.unstable_cancelCallback=function(O){O.callback=null},o.unstable_forceFrameRate=function(O){0>O||125<O?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):_e=0<O?Math.floor(1e3/O):5},o.unstable_getCurrentPriorityLevel=function(){return L},o.unstable_next=function(O){switch(L){case 1:case 2:case 3:var q=3;break;default:q=L}var ee=L;L=q;try{return O()}finally{L=ee}},o.unstable_requestPaint=function(){P=!0},o.unstable_runWithPriority=function(O,q){switch(O){case 1:case 2:case 3:case 4:case 5:break;default:O=3}var ee=L;L=O;try{return q()}finally{L=ee}},o.unstable_scheduleCallback=function(O,q,ee){var ge=o.unstable_now();switch(typeof ee=="object"&&ee!==null?(ee=ee.delay,ee=typeof ee=="number"&&0<ee?ge+ee:ge):ee=ge,O){case 1:var m=-1;break;case 2:m=250;break;case 5:m=1073741823;break;case 4:m=1e4;break;default:m=5e3}return m=ee+m,O={id:C++,callback:q,priorityLevel:O,startTime:ee,expirationTime:m,sortIndex:-1},ee>ge?(O.sortIndex=ee,u(x,O),h(b)===null&&O===h(x)&&(H?(_(ze),ze=-1):H=!0,Ve(J,ee-ge))):(O.sortIndex=m,u(b,O),X||W||(X=!0,Me||(Me=!0,Ge()))),O},o.unstable_shouldYield=tt,o.unstable_wrapCallback=function(O){var q=L;return function(){var ee=L;L=q;try{return O.apply(this,arguments)}finally{L=ee}}}}(To)),To}var zu;function Lx(){return zu||(zu=1,wo.exports=Rx()),wo.exports}var ko={exports:{}},Qe={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Ru;function Mx(){if(Ru)return Qe;Ru=1;var o=Oo();function u(b){var x="https://react.dev/errors/"+b;if(1<arguments.length){x+="?args[]="+encodeURIComponent(arguments[1]);for(var C=2;C<arguments.length;C++)x+="&args[]="+encodeURIComponent(arguments[C])}return"Minified React error #"+b+"; visit "+x+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function h(){}var d={d:{f:h,r:function(){throw Error(u(522))},D:h,C:h,L:h,m:h,X:h,S:h,M:h},p:0,findDOMNode:null},p=Symbol.for("react.portal");function g(b,x,C){var M=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:p,key:M==null?null:""+M,children:b,containerInfo:x,implementation:C}}var S=o.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;function N(b,x){if(b==="font")return"";if(typeof x=="string")return x==="use-credentials"?x:""}return Qe.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=d,Qe.createPortal=function(b,x){var C=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!x||x.nodeType!==1&&x.nodeType!==9&&x.nodeType!==11)throw Error(u(299));return g(b,x,null,C)},Qe.flushSync=function(b){var x=S.T,C=d.p;try{if(S.T=null,d.p=2,b)return b()}finally{S.T=x,d.p=C,d.d.f()}},Qe.preconnect=function(b,x){typeof b=="string"&&(x?(x=x.crossOrigin,x=typeof x=="string"?x==="use-credentials"?x:"":void 0):x=null,d.d.C(b,x))},Qe.prefetchDNS=function(b){typeof b=="string"&&d.d.D(b)},Qe.preinit=function(b,x){if(typeof b=="string"&&x&&typeof x.as=="string"){var C=x.as,M=N(C,x.crossOrigin),L=typeof x.integrity=="string"?x.integrity:void 0,W=typeof x.fetchPriority=="string"?x.fetchPriority:void 0;C==="style"?d.d.S(b,typeof x.precedence=="string"?x.precedence:void 0,{crossOrigin:M,integrity:L,fetchPriority:W}):C==="script"&&d.d.X(b,{crossOrigin:M,integrity:L,fetchPriority:W,nonce:typeof x.nonce=="string"?x.nonce:void 0})}},Qe.preinitModule=function(b,x){if(typeof b=="string")if(typeof x=="object"&&x!==null){if(x.as==null||x.as==="script"){var C=N(x.as,x.crossOrigin);d.d.M(b,{crossOrigin:C,integrity:typeof x.integrity=="string"?x.integrity:void 0,nonce:typeof x.nonce=="string"?x.nonce:void 0})}}else x==null&&d.d.M(b)},Qe.preload=function(b,x){if(typeof b=="string"&&typeof x=="object"&&x!==null&&typeof x.as=="string"){var C=x.as,M=N(C,x.crossOrigin);d.d.L(b,C,{crossOrigin:M,integrity:typeof x.integrity=="string"?x.integrity:void 0,nonce:typeof x.nonce=="string"?x.nonce:void 0,type:typeof x.type=="string"?x.type:void 0,fetchPriority:typeof x.fetchPriority=="string"?x.fetchPriority:void 0,referrerPolicy:typeof x.referrerPolicy=="string"?x.referrerPolicy:void 0,imageSrcSet:typeof x.imageSrcSet=="string"?x.imageSrcSet:void 0,imageSizes:typeof x.imageSizes=="string"?x.imageSizes:void 0,media:typeof x.media=="string"?x.media:void 0})}},Qe.preloadModule=function(b,x){if(typeof b=="string")if(x){var C=N(x.as,x.crossOrigin);d.d.m(b,{as:typeof x.as=="string"&&x.as!=="script"?x.as:void 0,crossOrigin:C,integrity:typeof x.integrity=="string"?x.integrity:void 0})}else d.d.m(b)},Qe.requestFormReset=function(b){d.d.r(b)},Qe.unstable_batchedUpdates=function(b,x){return b(x)},Qe.useFormState=function(b,x,C){return S.H.useFormState(b,x,C)},Qe.useFormStatus=function(){return S.H.useHostTransitionStatus()},Qe.version="19.1.1",Qe}var Lu;function _x(){if(Lu)return ko.exports;Lu=1;function o(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(o)}catch(u){console.error(u)}}return o(),ko.exports=Mx(),ko.exports}/**
 * @license React
...
print(res)
`}),e.jsxs("div",{class:"output",children:[e.jsx("h4",{children:"Output"}),e.jsx("p",{children:"[1, 2, 3, 4, 5, 6, 7, 8, 9]"})]}),e.jsxs("p",{children:[e.jsx("strong",{children:"Explanation:"})," The line [val for row in mat for val in row] uses nested list comprehension to iterate through each row in mat. For each row, it iterates through each val in that row and collecting all values into a single list."]})]})]})});function Tg(){return e.jsx(e.Fragment,{children:e.jsx("div",{children:e.jsxs(Nm,{children:[e.jsx(F,{path:"/",element:e.jsx(dj,{})}),e.jsx(F,{path:"/Sign",element:e.jsx(uj,{})}),e.jsx(F,{path:"/Home",element:e.jsx(mj,{})}),e.jsx(F,{path:"/account",element:e.jsx(hj,{})}),e.jsx(F,{path:"/CCourse",element:e.jsx(jj,{})}),e.jsx(F,{path:"/Introduction",element:e.jsx(gj,{})}),e.jsx(F,{path:"/Identifier",element:e.jsx(yj,{})}),e.jsx(F,{path:"/Keywords",element:e.jsx(bj,{})}),e.jsx(F,{path:"/Variables",element:e.jsx(vj,{})}),e.jsx(F,{path:"/Datatypes",element:e.jsx(wj,{})}),e.jsx(F,{path:"/Inputoutput",element:e.jsx(Tj,{})}),e.jsx(F,{path:"/Operators",element:e.jsx(kj,{})}),e.jsx(F,{path:"/Conditional",element:e.jsx(Sj,{})}),e.jsx(F,{path:"/Loops",element:e.jsx(Cj,{})}),e.jsx(F,{path:"/Function",element:e.jsx(Aj,{})}),e.jsx(F,{path:"/Parameter",element:e.jsx(Ej,{})}),e.jsx(F,{path:"/MainFun",element:e.jsx(Oj,{})}),e.jsx(F,{path:"/Recursion",element:e.jsx(Nj,{})}),e.jsx(F,{path:"/Inline",element:e.jsx(Dj,{})}),e.jsx(F,{path:"/NestedFun",element:e.jsx(zj,{})}),e.jsx(F,{path:"/Array",element:e.jsx(Rj,{})}),e.jsx(F,{path:"/Pointer",element:e.jsx(Lj,{})}),e.jsx(F,{path:"/String",element:e.jsx(Mj,{})}),e.jsx(F,{path:"/Structure",element:e.jsx(_j,{})}),e.jsx(F,{path:"/Union",element:e.jsx(Uj,{})}),e.jsx(F,{path:"/Enum",element:e.jsx(Hj,{})}),e.jsx(F,{path:"/Layout",element:e.jsx(qj,{})}),e.jsx(F,{path:"/Allocate",element:e.jsx(Ij,{})}),e.jsx(F,{path:"/Leak",element:e.jsx(Pj,{})}),e.jsx(F,{path:"/Linked",element:e.jsx(Fj,{})}),e.jsx(F,{path:"/Stack",element:e.jsx(Bj,{})}),e.jsx(F,{path:"/Queue",element:e.jsx(Gj,{})}),e.jsx(F,{path:"/Hash",element:e.jsx(Vj,{})}),e.jsx(F,{path:"/Binarytree",element:e.jsx(Yj,{})}),e.jsx(F,{path:"/Heap",element:e.jsx(Xj,{})}),e.jsx(F,{path:"/Graph",element:e.jsx(Qj,{})}),e.jsx(F,{path:"/Python",element:e.jsx(Wj,{})}),e.jsx(F,{path:"/Pintroduction",element:e.jsx(Kj,{})}),e.jsx(F,{path:"/PInput",element:e.jsx(Zj,{})}),e.jsx(F,{path:"/Pvariable",element:e.jsx(Jj,{})}),e.jsx(F,{path:"/Poperator",element:e.jsx($j,{})}),e.jsx(F,{path:"/Pkeyword",element:e.jsx(eg,{})}),e.jsx(F,{path:"/Pdatatype",element:e.jsx(tg,{})}),e.jsx(F,{path:"/Pconditional",element:e.jsx(ng,{})}),e.jsx(F,{path:"/Ploop",element:e.jsx(ig,{})}),e.jsx(F,{path:"/PDef",element:e.jsx(sg,{})}),e.jsx(F,{path:"/PUse",element:e.jsx(rg,{})}),e.jsx(F,{path:"/Preturn",element:e.jsx(ag,{})}),e.jsx(F,{path:"/Pglobal",element:e.jsx(lg,{})}),e.jsx(F,{path:"/Precursion",element:e.jsx(og,{})}),e.jsx(F,{path:"/Pargs",element:e.jsx(cg,{})}),e.jsx(F,{path:"/Pself",element:e.jsx(dg,{})}),e.jsx(F,{path:"/Pfirst",element:e.jsx(hg,{})}),e.jsx(F,{path:"/Plambda",element:e.jsx(ug,{})}),e.jsx(F,{path:"/Pmap",element:e.jsx(pg,{})}),e.jsx(F,{path:"/Pinner",element:e.jsx(fg,{})}),e.jsx(F,{path:"/Pdeco",element:e.jsx(xg,{})}),e.jsx(F,{path:"/Pstring",element:e.jsx(mg,{})}),e.jsx(F,{path:"/Plist",element:e.jsx(jg,{})}),e.jsx(F,{path:"/Ptuple",element:e.jsx(gg,{})}),e.jsx(F,{path:"/Pdict",element:e.jsx(yg,{})}),e.jsx(F,{path:"/Pset",element:e.jsx(bg,{})}),e.jsx(F,{path:"/Parray",element:e.jsx(vg,{})}),e.jsx(F,{path:"/Pcom",element:e.jsx(wg,{})})]})})})}Ix.createRoot(document.getElementById("root")).render(e.jsx($m,{children:e.jsx(Tg,{})}));
